...
kubeadm init --pod-network-cidr=192.168.0.0/16 --kubernetes-version=v1.13.0 --apiserver-advertise-address=192.168.3.226
  ...
  **注意，记录下如下信息**
  ...
  ![](https://github.com/Lengxiaobing/Lengxiaobing.github.io/tree/master/img/docs-pics/docker01.png)
...
![](https://github.com/Lengxiaobing/Lengxiaobing.github.io/tree/master/img/docs-pics/docker02.png)
...
kubectl describe secret admin-token-99t6x  -n kube-system
  ...
  ![](https://github.com/Lengxiaobing/Lengxiaobing.github.io/tree/master/img/docs-pics/docker03.png)
