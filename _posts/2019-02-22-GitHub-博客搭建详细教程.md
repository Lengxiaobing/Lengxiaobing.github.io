...
> [我的博客](https://lengxiaobing.github.io/)

# 前言
使用 [GitHub Pages](https://pages.github.com/) + [jekyll](http://jekyll.com.cn/) ，查找了一些教程，终于把我的个人博客搭建出来了......
...
这是我的 Baidu Analytics

![](https://upload-images.jianshu.io/upload_images/6970677-f717fc14f8c6a025.png?imageMogr2/auto-orient/)
...
所以，要在 MarkDown中插入图片，这张图片就需要上传到图床（网上），然后在引用这张图片的URL。
...
[Typora](https://typora.io/)：Windows上比较好用的MacDown编辑器

**图片压缩工具**

[ImageOptim](https://imageoptim.com/)

对于我们的博客来说，图片越大，加载速度越慢。一般 `800kb` 是一个比较好的选择。
